...
export class SearchRecipeComponent implements OnInit {
  ...
  recepieAppid = '&app_id=954fb537';
  recepieKey = '&app_key=\n' +
    '126ce360bf3f01d3b1698ac145e61a25\t';
  placesApi = 'https://api.foursquare.com/v2/venues/search?';
  clientdId = 'client_id=HHBRKDKKGRMEX10ZF4YOYO3GAUEDJGE3I55XUY1HG213R5UB';
  clientSecret = '&client_secret=UFL2RBKMIJH1CYL400B5DDISODS2442Z1MT342HSDQACIWH0';
  version = '&v=20180323';
  near = '&near=';
  query = '&query=';
